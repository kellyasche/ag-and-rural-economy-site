...
Overall, farm employment has been decreasing in every region across the state since 2001. The crop commodity boom slowed the decline between 2008 and 2012, however the declines have continued since that period. 

Overall, farm employment makes up a small percentage of total employment across most of the state. Even in our most rural counties, farm employment averages 15% of total employment. 
...
These thresholds provided us with 23 counties. After examining the trends in these counties, 14 counties were identified as possibly being impacted by the decline in farm employment.
...
```{r table of most disuprted counties summary}
