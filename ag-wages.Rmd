...
## Counties most disrupted by ag-related wages

There are only a couple of counties that have been potentially been disrupted by the decline of ag-related wages; Lac qui Parle, Faribault, and Waseca. The other counties experiencing a decline in ag-related wages did not translate into lower overall wages. For these counties, it potentially means a couple of things;
...
```{r prep ag and total wages index of three impacted counties, include=FALSE, cache=TRUE}
