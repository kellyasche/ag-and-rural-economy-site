...
The analysis below highlights the fact that wages earned from ag-related industries play a relatively minor role in most regions across the state. A large majority of counties experiencing a decline in ag-related wages did not translate into lower total wages earned. For these counties, it potentially means a couple of things;
