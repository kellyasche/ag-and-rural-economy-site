...
```{r prep farm earnings and total earnings, include = FALSE}
...
```{r index farm earnings edr, fig.height= 12}
...
```{r farm earnings pct of total earnings ruca}
...
```{r farm earnings pct of total earnings pr}
...
```{r farm earnings pct of total earnings edr, fig.height=12}
