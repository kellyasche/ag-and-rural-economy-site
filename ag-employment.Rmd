...
On average, 10% to 15% of total employment is in ag-related industries in our most rural areas of the state, particularly in the Southwest, and less than 5% everywhere else. 
...
In particular, the EDRs in the Northwest and Central parts of the state are continuing to see growth in their employment by ag-related industries. The Southwest Region is experiencing an increase in ag-employment as a whole, but EDR 6W - Upper Minnesota Valley has experienced declines, however.

Analysis provided guidance on the characteristics of a county where they might be most impacted by employment trends in ag-related industries, both positively and negatively;
...
When applying these filters, we end up with 25 counties that fall into two distinct groups; 
